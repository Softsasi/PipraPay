...
class AlArafahBankPlcGateway
{
    ...
    public function lang_text()
    {
        return [
            '1' => [
                'en' => 'Bank Name: Al-Arafah Islami Bank PLC',
                'bn' => 'ব্যাংকের নাম: Al-Arafah Islami Bank PLC',
                'hi' => 'बैंक का नाम: Al-Arafah Islami Bank PLC',
                'ur' => 'بینک کا نام: Al-Arafah Islami Bank PLC',
                'ar' => 'اسم البنك: Al-Arafah Islami Bank PLC',
            ],
