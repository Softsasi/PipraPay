...
class BbpBankGateway
{
    ...
    public function lang_text()
    {
        return [
            '1' => [
                'en' => 'Bank Name: BRAC Bank PLC',
                'bn' => 'ব্যাংকের নাম: BRAC Bank PLC',
                'hi' => 'बैंक का नाम: BRAC Bank PLC',
                'ur' => 'بینک کا نام: BRAC Bank PLC',
                'ar' => 'اسم البنك: BRAC Bank PLC',
            ],
