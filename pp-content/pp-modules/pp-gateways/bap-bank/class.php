...
class BapBankGateway
{
    ...
    public function lang_text()
    {
        return [
            '1' => [
                'en' => 'Bank Name: Bank Asia PLC',
                'bn' => 'ব্যাংকের নাম: Bank Asia PLC',
                'hi' => 'बैंक का नाम: Bank Asia PLC',
                'ur' => 'بینک کا نام: Bank Asia PLC',
                'ar' => 'اسم البنك: Bank Asia PLC',
            ],
