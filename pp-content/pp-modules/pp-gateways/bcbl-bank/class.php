...
class BcblBankGateway
{
    ...
    public function lang_text()
    {
        return [
            '1' => [
                'en' => 'Bank Name: Bangladesh Commerce Bank Limited',
                'bn' => 'ব্যাংকের নাম: Bangladesh Commerce Bank Limited',
                'hi' => 'बैंक का नाम: Bangladesh Commerce Bank Limited',
                'ur' => 'بینک کا نام: Bangladesh Commerce Bank Limited',
                'ar' => 'اسم البنك: Bangladesh Commerce Bank Limited',
            ],
